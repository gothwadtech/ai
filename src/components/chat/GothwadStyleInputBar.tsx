...
import { 
  ArrowUp, Plus, Mic, MicOff, Paperclip, Loader2, RotateCcw, AlertCircle, Send
} from "lucide-react";
...
export interface GothwadStyleInputBarProps {
  input: string;
  ...
  // Quick Actions & Active File Context
  ...
  // Model & Agent Selectors (Bottom Strip)
...
export default function GothwadStyleInputBar({
  input,
  setInput,
  isLoading,
  onSend,
  ...
  return (
    <div className="pt-0.5 pb-1 px-2 sm:px-3 shrink-0 bg-transparent relative z-20 w-full select-none">
      <div className="max-w-3xl mx-auto w-full">
        ...
        {/* Gemini-Style Capsule Input Form Container */}
        <div 
        ...
        >
          ...
          <div className="flex items-center gap-1.5 w-full">
              ...
              {setAttachedFiles ? (
                <>
                  <button
                    ...
                    disabled={isLoading}
                    className="p-2 bg-zinc-950 hover:bg-zinc-850 text-zinc-400 hover:text-white border border-zinc-800 rounded-xl transition-all cursor-pointer active:scale-95 flex items-center justify-center shrink-0"
                    title="Attach local code file (up to 250KB)"
                  >
                ...
                <button
                  ...
                  onClick={() => setInput("")}
                  disabled={!input}
                  className="p-2 bg-zinc-950 hover:bg-zinc-850 text-zinc-400 hover:text-white border border-zinc-800 rounded-xl disabled:opacity-30 transition-all cursor-pointer active:scale-95 flex items-center justify-center shrink-0"
                  title="Reset Text"
                >
            ...
            {/* Voice Dictation & Circular Send Button Cluster */}
